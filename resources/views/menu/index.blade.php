    ...
    <div class="">
        <header class="bg-indigo-200 shadow-md rounded-xl w-full text-sm py-4 px-6 flex justify-between items-center">
            <div class="flex items-center space-x-2 text-2xl">
                ...
                <span class="text-indigo-900"><strong>[ADMIN - MENU]</strong></span>
            </div>

            <div class="flex items-center gap-1">
                <x-content-header-buttons route="menu.create" icon="ti ti-plus" bgCollor='bg-green-500'
                    hoverBgCollor='hover:bg-green-600' textCollor="text-white" title="Criar um novo menu" />
            </div>
        </header>
