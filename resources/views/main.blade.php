<x-layouts.auth_layout>
    <div class="">
        ...
        <i class="ti ti-user-square text-6xl"></i>
        ...
        <div
            ...
            <x-chart-card title="RADAR" subtitle="Gráfico tipo radar" icon="ti ti-users text-white"
                iconBg="bg-blue-500" lgColor="text-black" txColor="text-gray-800" chart-type="radar" :chart-data="[50, 60, 55, 70, 65, 80, 90]"
                :chart-labels="['Dia 1', 'Dia 5', 'Dia 10', 'Dia 15', 'Dia 20', 'Dia 25', 'Dia 30']" :chart-color="[
                    'rgba(59, 130, 246, 0.5)',
                    'rgba(16, 185, 129, 0.5)',
                    'rgba(234, 179, 8, 0.5)',
                    'rgba(244, 63, 94, 0.5)',
            ...
            <x-chart-card title="DOUGHNUT" subtitle="Gráfico tipo rosquinha" icon="ti ti-moneybag bg text-black"
                iconBg="bg-yellow-300" bgColor="bg-black" lgColor="text-white" txColor="text-gray-300"
                chart-type="doughnut" :chart-data="[50.5, 60.15, 55.14, 70.25, 65.35, 80.95, 90]" :chart-labels="['Dia 1', 'Dia 5', 'Dia 10', 'Dia 15', 'Dia 20', 'Dia 25', 'Dia 30']" :chart-color="[
                    'rgba(59, 130, 246, 0.5)',
                    'rgba(16, 185, 129, 0.5)',
                    'rgba(234, 179, 8, 0.5)',
                    'rgba(244, 63, 94, 0.5)',
        ...
        <div
            ...
            <x-chart-card title="PIE" subtitle="Gráfico tipo pizza" icon="ti ti-users text-white"
                iconBg="bg-purple-700" bgColor="bg-purple-300" lgColor="text-purple-900" txColor="text-purple-800"
                chart-type="pie" :chart-data="[50, 60, 55, 70, 65, 80, 90]" :chart-labels="['Dia 1', 'Dia 5', 'Dia 10', 'Dia 15', 'Dia 20', 'Dia 25', 'Dia 30']" :chart-color="[
                    'rgba(59, 130, 246, 0.5)',
                    'rgba(16, 185, 129, 0.5)',
                    'rgba(234, 179, 8, 0.5)',
                    'rgba(244, 63, 94, 0.5)',
            ...
            <x-chart-card title="BAR" subtitle="Gráfico tipo barra" icon="ti ti-cash bg text-indigo-100"
                iconBg="bg-indigo-700" bgColor="bg-indigo-200" lgColor="text-indigo-900" txColor="text-indigo-800"
                chart-type="bar" :chart-data="[50.5, 60.15, 55.14, 70.25, 65.35, 80.95, 90]" :chart-labels="['Dia 1', 'Dia 5', 'Dia 10', 'Dia 15', 'Dia 20', 'Dia 25', 'Dia 30']" :chart-color="[
                    'rgba(59, 130, 246, 0.5)',
                    'rgba(16, 185, 129, 0.5)',
                    'rgba(234, 179, 8, 0.5)',
                    'rgba(244, 63, 94, 0.5)',
